 ...
 * @author Pankaj
 */
public class java_Ques4 extends javax.swing.JFrame {
int score;
    ...
    private void initComponents() {
        ...
        setTitle("JAVA QUESTION 4");
        setPreferredSize(new java.awt.Dimension(661, 415));

        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("Which of the following is an immediate subclass of the Panel class?");
        ...
        jButton1.setMinimumSize(new java.awt.Dimension(769, 23));
        jButton1.setPreferredSize(new java.awt.Dimension(69, 23));
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 330, -1, 30));

        jButton2.setText("SUBMIT");
        jButton2.setMinimumSize(new java.awt.Dimension(769, 23));
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 283, -1, 30));
        ...
        jLabel1.setPreferredSize(new java.awt.Dimension(661, 415));
...
q3.initScore(score);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(java_Ques4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       if(res==JOptionPane.YES_NO_OPTION) 
       {
                new LOGINPAGE().setVisible(true);
                       new java_Ques4().setVisible(false);
            }
