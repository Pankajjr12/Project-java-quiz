 ...
 * @author Pankaj
 */
public class c_Ques7 extends javax.swing.JFrame {
int score;
    ...
    private void initComponents() {
        ...
        buttongroupques7 = new javax.swing.ButtonGroup();
        ...
        setTitle("C/C++ QUESTION 7");
        setPreferredSize(new java.awt.Dimension(661, 416));

        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("Which operator can not be overloaded?");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 70, 390, -1));

        buttongroupques7.add(opt1);
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(4, 0, 660, 410));
...
q2.initScore(score);
    ...
    if (opt1.isSelected()|| opt4.isSelected() || opt3.isSelected())
    {
        Component frame=null;
        c_Ques8 obj1=new c_Ques8();
...
obj1.initScore(score);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(c_Ques7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.ButtonGroup buttongroupques7;
